...
| Binary | What it is |
|---|---|
| `arachnid-core` | the triage CLI — collect, capture, parse-pcap, verify, report |
| `arachnid-sanitize` | **destructive.** Secure erasure — see [Arachnid Sanitize](#arachnid-sanitize) |
| `arachnid-tui` | the terminal UI over both modules |
...
|---|---|---|---|---|---|
| tcp | 172.16.0.2:43290 | 160.79.104.10:443 | ESTABLISHED | 11519 | claude |
